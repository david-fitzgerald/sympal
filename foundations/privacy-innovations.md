...
### Ephemeral Slots Evolution (V2+ Vision)

> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#the-ephemeral-slots-roadmap-from-technique-to-paradigm)**
>
> The Ephemeral Slots paradigm scales beyond V1:
> - V1.5: Dynamic Legend Optimization
> - V2: Composable & Nested Slots
> - V2.5: Functional Slots
> - V3: The Ephemeral Self (per-query digital twin)
>
> See the full research document for detailed designs.
...
> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#p2p-query-mixing)**
>
> Multi-user traffic obfuscation through query mixing. Requires user base — not applicable for V1 dogfooding.
...
### V2: Privacy Sandbox Mode

> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#ux-controls-v2)**
>
> "Try with fake data" onboarding flow. Valuable for new users, not needed for V1 dogfooding.
...
> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#security-controls-v2)**
>
> - **V2: Tamper-Evident Audit Chain** — Hash-chain for forensic accountability
> - **V2: Minimal-Exposure Proofs** — Justification-driven serialization
>
> These are valuable for multi-user or compliance scenarios, not needed for V1 dogfooding.
...
### V2+ Advanced Privacy Techniques

> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#advanced-privacy-techniques)**
>
> Extensive research on future privacy enhancements:
> - The Foundry (reusable personal API)
> - Semantic Projection (type-based shadows)
> - Amnesic Reasoning (stateless micro-queries)
> - Two-Tier Reasoning (structure/content separation)
> - Latent Space Scaffolding (geometry-based privacy)
> - And many more architectural ideas
>
> These are documented for post-V1 evolution. Not in V1 scope.
...
> **Full V2+ research moved to [privacy-roadmap-full.md](privacy-roadmap-full.md#correlation-mitigations-v2)**
>
> Query padding, multi-provider distribution, decoy sessions. For when V1 mitigations prove insufficient.
